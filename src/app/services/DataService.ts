...
export class DataService {
   ...
   */
  static convertCategoryProductToProduct(categoryProduct: CategoryProduct): Product {
    return {
      id: categoryProduct.id,
      name: categoryProduct.title,
      price: parseFloat(categoryProduct.price.replace('R$ ', '').replace(',', '.')),
   ...
   */
  static filterAndSortProducts(products: Product[], searchTerm?: string): Product[] {
   ...
   */
  static prepareCategoryProducts(categoryProducts: CategoryProduct[]): Product[] {

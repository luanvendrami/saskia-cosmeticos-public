...
export const skincareProducts: CategoryProduct[] = [
  ...
  },
  {
    ...
    price: "R$ 79,90",
    description:
      "Sérum concentrado de vitamina C para uniformizar o tom da pele.",
    primeiroCarrossel: false,
    category: "Skin Care",
    stockQuantity: 7,
    topSell: true,
  ...
  },
  {
    ...
    price: "R$ 45,90",
    description:
      "Tônico adstringente para equilibrar o pH da pele e fechar os poros.",
    primeiroCarrossel: false,
    category: "Skin Care",
    stockQuantity: 12,
    topSell: true,
  ...
  },
  {
    ...
    price: "R$ 55,90",
    description:
      "Esfoliante suave para remover células mortas e desobstruir os poros.",
    primeiroCarrossel: false,
    category: "Skin Care",
    stockQuantity: 6,
    topSell: true,
  ...
  },
  {
    ...
    price: "R$ 39,90",
    description:
      "Demaquilante bifásico para remoção de maquiagem à prova d'água.",
    primeiroCarrossel: false,
    category: "Skin Care",
    stockQuantity: 15,
    topSell: true,
  ...
  },
  {
    ...
    price: "R$ 69,90",
    description:
      "Creme específico para a área dos olhos, reduz olheiras e bolsas.",
    primeiroCarrossel: false,
    category: "Skin Care",
    stockQuantity: 18,
    topSell: true,
